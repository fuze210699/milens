...
| Work in the Docs area | `.github/instructions/docs.instructions.md` |
...
| Work in the Ui area | `.github/instructions/ui.instructions.md` |
| Execute milens-plan workflow | `.github/instructions/milens-plan.instructions.md` |
| Execute milens-code-review workflow | `.github/instructions/milens-code-review.instructions.md` |
| Execute milens-tdd workflow | `.github/instructions/milens-tdd.instructions.md` |
| Execute milens-security-review workflow | `.github/instructions/milens-security-review.instructions.md` |
| Execute milens-refactor-clean workflow | `.github/instructions/milens-refactor-clean.instructions.md` |
| Execute milens-eval workflow | `.github/instructions/milens-eval.instructions.md` |
| Execute milens-architect workflow | `.github/instructions/milens-architect.instructions.md` |
| Execute milens-debugger workflow | `.github/instructions/milens-debugger.instructions.md` |
