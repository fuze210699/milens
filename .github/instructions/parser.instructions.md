...
- **`loadLanguage`** [function] (src/parser/loader.ts:21) — 8 refs
- **`getParser`** [function] (src/parser/loader.ts:32) — 7 refs
- **`extractFromTree`** [function] (src/parser/extract.ts:183) — 6 refs
...
- **`clearQueryCache`** [function] (src/parser/extract.ts:61) — 2 refs
...
- **`loadLanguage`** [function] — 8 incoming references
- **`getParser`** [function] — 7 incoming references
- **`extractFromTree`** [function] — 6 incoming references
- **`extractHtmlScripts`** [function] — 4 incoming references

## Dependencies
- **root**: `CodeSymbol`, `RawImport`, `RawCall`, `RawHeritage`, `RawReExport`, `ExtractionResult`, `SymbolKind`, `has`
- **server**: `get`
- **analyzer**: `clear`, `find`, `resolve`
- **store**: `load`
