...
## Key Symbols
- **`createMcpServer`** [function] (src/server/mcp.ts:421) — 2 refs
- **`startStdio`** [function] (src/server/mcp.ts:2327) — 2 refs
- **`startHttp`** [function] (src/server/mcp.ts:2335) — 2 refs
