...
## Overview
Contains 33 symbols (8 exported) across 5 files.

## Key Symbols
- **`resolveLinksWithStats`** [function] (src/analyzer/resolver.ts:25) — 2 refs
...
- **`resolveLinks`** [function] (src/analyzer/resolver.ts:20) — 1 refs
...
- **`resolveLinksWithStats`** [function] — 2 incoming references
