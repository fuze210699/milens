...
## Overview
Contains 47 symbols (2 exported) across 2 files.
...
- **parser**: `clear`, `load`
- **server**: `close`, `findByRoot`, `listAll`, `findDbPath`, `searchSymbols`, `findSymbolByName`, `getIncomingLinks`, `findSymbolById` (+10 more)
